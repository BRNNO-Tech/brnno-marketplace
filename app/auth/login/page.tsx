  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-black to-blue-900 p-6">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        <h2 className="text-3xl font-bold mb-6 text-center">Log In to Brnno</h2>
        <button
          onClick={googleSignup}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition font-medium mb-6"
        >
        ...
        <input
          ...
          className="w-full p-4 border-2 border-gray-200 rounded-lg mb-6 focus:border-blue-500 focus:outline-none"
        />
        <button
          onClick={login}
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          No account?{" "}
          <a href="/auth/signup" className="text-blue-600 font-semibold hover:underline">Sign up free</a>
        </p>
      </div>
    </div>
  );
